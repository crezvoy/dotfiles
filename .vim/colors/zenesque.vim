...
hi Constant     guifg=#353535          guibg=bg        gui=bold
...
hi IncSearch    guifg=#000000          guibg=orange    gui=italic "#adadad 
hi Search       guifg=#000000          guibg=orange    gui=NONE   "#c5c3c3
...
hi NonText      guifg=bg               guibg=bg        gui=bold
...
hi qfFileName       guifg=#6a6a6a      guibg=bg      gui=bold
hi qfLineNr         guifg=#6a6a6a      guibg=bg      gui=bold
...
elseif exists('g:zenesque_colors') && g:zenesque_colors==2
    ...
    hi Constant     guifg=#848484          guibg=bg        gui=bold
    ...
    hi IncSearch    guifg=#ffffff          guibg=#d75f00   gui=NONE
    hi Search       guifg=#000000          guibg=#d75f00   gui=NONE
    hi MatchParen   guifg=#000000          guibg=#a8a8a8   gui=bold
    hi ModeMsg      guifg=#ffffff          guibg=#767676   gui=bold
    hi MoreMsg      guifg=#7c7c7c          guibg=bg        gui=bold
    hi NonText      guifg=bg               guibg=bg        gui=bold
    ...
    hi SpellBad     guisp=#d75f5f          guibg=bg        gui=undercurl
    hi SpellCap     guisp=#ffffaf                          gui=undercurl
    hi SpellLocal   guisp=#434343                          gui=undercurl
    hi SpellRare    guisp=#7d7d7d                          gui=undercurl
    ...
    hi Boolean      guifg=#616060          guibg=NONE      gui=bold
    hi Ignore       guifg=bg               guibg=NONE      gui=NONE
    hi Error        guifg=#d75f5f          guibg=bg        gui=bold
    " -----------------------------------------------------------------------------
    hi VimError         guifg=#b6b6b6      guibg=#313131   gui=bold
    hi VimCommentTitle  guifg=#5c5c5c      guibg=bg        gui=bold,italic
    hi qfFileName       guifg=#6a6a6a      guibg=bg        gui=bold
...
elseif exists('g:zenesque_colors') && g:zenesque_colors==3
    ...
    hi Constant     guifg=#8d5c57          guibg=bg        gui=NONE
...
if &t_Co > 255
   ...
   hi  Constant           ctermfg=244        ctermbg=NONE       cterm=bold
   ...
   hi  IncSearch          ctermfg=256        ctermbg=166        cterm=NONE
   hi  Search             ctermfg=0          ctermbg=166        cterm=NONE
   ...
   hi  NonText            ctermfg=bg         ctermbg=bg         cterm=bold
